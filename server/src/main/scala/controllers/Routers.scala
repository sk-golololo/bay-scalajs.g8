...
import controllers.swagger.{PetService, StoreService, UserService}
...
class PetServiceImpl(application: controllers.Application, assets: controllers.Assets) extends PetService {
}

class StoreServiceImpl(application: controllers.Application, assets: controllers.Assets) extends StoreService {
}

class UserServiceImpl(application: controllers.Application, assets: controllers.Assets)  extends UserService {
}

class PetRouterO(service : PetService) {
  val router = new ScaladslServiceRouter(PetRouter(petService).descriptor, petService, httpConfiguration)
}
