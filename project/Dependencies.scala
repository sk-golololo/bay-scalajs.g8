object Dependencies {
  ...
  // ScalaJs
  val scalajsReact = "1.1.1" // https://github.com/japgolly/scalajs-react/blob/master/doc/USAGE.md
  val scalajsDom = "0.9.2" // https://scala-js.github.io/scala-js-dom/

  // jsDependencies
  val react = "15.6.1" // https://facebook.github.io/react/
